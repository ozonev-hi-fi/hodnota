...
2. Check CI: `gh pr checks <number>` (every PR runs `.github/workflows/ci.yml` — see [decisions/0004](decisions/0004-scaffold-backend-and-web-app.md)). `gh pr view <number>` for the PR's general state/URL.
